...
def index():
    if request.method == "POST":
        ...
        s2 = "The score of credit card upgrade based on linear regression is " +str(pred2)
        
        model3=joblib.load("CCU_NN")
        pred3 =  model3.predict([[purchases,suppcard]])
        s3 = "The score of credit card upgrade based on neural networks is " +str(pred3)
        ...
        s5 = "The score of credit card upgrade based on gradient booster is " +str(pred5)
